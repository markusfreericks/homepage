...
- in that time, i was part of a computer music group (CAMP), my Vordiplom work was a real-time Scheme implemenation based on an existing Forth interpreter (FORMULA, Forth Music Language) with an embedded cooperative multithreading realtime support
...
- wrote and maintained a big chunk of Java software, that in one or another form is still running at a big german automative company (the oldest code commit is from 2005)
